...
testalleles = [10 20 40 80 120];

for ii = 1:5 % numberofalleles are changed within this loop
...
set(gca,'xtick',testalleles)
hold on
errorbar(testalleles,mean(timetofixationcyst),CIerrorcyst,'bx','LineWidth',1.5)
errorbar(testalleles,mean(timetofixationnocyst),CIerrornocyst,'rx','LineWidth',1.5)
